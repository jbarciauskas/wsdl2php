  ...
  <tr>
    <td class="bannercell" rowspan="2">
      ...
      <img src="http://phing.info/images/phing.gif" alt="http://phing.info/" align="left" border="0"/>
        ...
        <tr>
        <td style="text-align:right">Designed for use with <a href='http://pear.php.net/package/PHPUnit'>PHPUnit</a>, <a href='http://www.xdebug.org/'>Xdebug</a> and <a href='http://phing.info/'>Phing</a>.</td>
        </tr>
  </table>
    <hr size="1"/>
</xsl:template>
