...
if (!defined("PHPUnit_MAIN_METHOD")) {
  define("PHPUnit_MAIN_METHOD", "AspDotNetRound2Test::main");
}
 ...
 */
class AspDotNetRound2Test extends Wsdl2PhpTestCase {

  private $service;
  
  public static function main() {
    require_once "PHPUnit/TextUI/TestRunner.php";
    $suite  = new PHPUnit_Framework_TestSuite("AspDotNetRound2Test");
...
if (PHPUnit_MAIN_METHOD == "AspDotNetRound2Test::main") {
  AspDotNetRound2Test::main();
}
